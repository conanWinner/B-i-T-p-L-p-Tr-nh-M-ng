 ...
 * @author Admin
 */
public class JRMICLient1 extends javax.swing.JFrame {
    ...
    public JRMICLient1() {
        try {
            ...
            server = (SyncInterface) registry.lookup("Sync2021");
            

        } catch (RemoteException ex) {
            Logger.getLogger(JRMICLient1.class.getName()).log(Level.SEVERE, null, ex);
...
//            Cập nhật dữ liệu
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JRMICLient1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JRMICLient1().setVisible(true);
            }
        });
    }
